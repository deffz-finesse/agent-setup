...
# Vendored copy of sprint-planning's sprint-status-template.yaml — skills
...
def test_detect_epic_matches_split_story_keys(tmp_path):
    # A split-story key like 2-6a-... is first-class in workflow (an oversized story
...
def test_action_status_vocabulary_is_exactly_the_three():
    # sprint-planning is the authority. Widening this tuple would let the
