...
````markdown
<!-- workflow:context -->
<!-- Verified 2026-08-08 against a1b2c3d. Managed by project-context; edits inside this block are replaced on refresh. Keep anything you want preserved outside the markers. -->
