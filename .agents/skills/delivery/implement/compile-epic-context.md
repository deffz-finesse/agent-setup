...
**Task**
Given the selected slice and its relevant rough-plan horizon, compile a clean,
focused, developer-ready `context.md` inside that slice's
`03-slices/<active-slice>/` folder. This is just-in-time planning context, not
