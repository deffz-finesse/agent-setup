...
**Immediate:** Implement `6-API-006` and `6-E2E-003`; re-run `/testarch-trace`.
...
traceability_and_gate:
  ...
  gate_decision:
    ...
    evidence:
      ...
      traceability: '05-testing/traceability-scheduled-reports-matrix.md'
...
- `05-testing/traceability-scheduled-reports-e2e-summary.json`: schema version 0.2.0, gate status CONCERNS, complete oracle, inventory, coverage, heuristic, live-evidence, blocker, and link fields
- `05-testing/traceability-scheduled-reports-gate-decision.json`: schema version 0.1.0, evaluated timestamp, priority-threshold gate basis, CONCERNS status, rationale, and per-criterion status
