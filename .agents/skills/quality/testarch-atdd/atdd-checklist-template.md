...
atddChecklistPath: '{test_artifacts}/atdd-checklist-{target_slug}.md'
generatedTestFiles:
  - '{api_test_file_path}'
  - '{e2e_test_file_path}'
...
- **Checklist Path:** `{test_artifacts}/atdd-checklist-{target_slug}.md`
...
**Generated by workflow TEA Agent** - {date}
