...
outputFile: '{test_artifacts}/atdd-checklist-{target_slug}.md'
...
```javascript
fs.writeFileSync(`{test_artifacts}/atdd-checklist-{target_slug}.md`, checklistContent, 'utf8');
```
...
- Record:
  - `Checklist: {test_artifacts}/atdd-checklist-{target_slug}.md`
...
- tests/fixtures/test-data.ts
- {test_artifacts}/atdd-checklist-{target_slug}.md
