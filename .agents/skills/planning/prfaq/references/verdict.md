**Output Location:** `{run_dir}/02-plan/prfaq/`
...
**Always produce the distillate** at `{run_dir}/02-plan/prfaq/prfaq-distillate.md`:

```yaml
---
title: "PRFAQ Distillate: {project_title}"
type: llm-distillate
source: "prfaq.md"
created: "{timestamp}"
...
**PRFAQ:** `{run_dir}/02-plan/prfaq/prfaq.md`
**Detail Pack:** `{run_dir}/02-plan/prfaq/prfaq-distillate.md`
...
```json
{
  "status": "complete",
  "prfaq": "{run_dir}/02-plan/prfaq/prfaq.md",
  "distillate": "{run_dir}/02-plan/prfaq/prfaq-distillate.md",
