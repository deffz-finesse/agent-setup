...
```json
{
  "status": "complete",
  "files": [
    "_artifacts/runs/<run-slug>/02-plan/spec/SPEC.md",
    "_artifacts/runs/<run-slug>/02-plan/spec/glossary.md",
    "_artifacts/runs/<run-slug>/02-plan/spec/.memlog.md"
  ]
}
```
...
```json
{
  ...
  "reason": "Input was a one-line idea with no surrounding context; too thin to distill. Suggest prd to draw the vision out first."
}
```
