...
- Resolve the selected initiative from `core.runs_root`; planning inputs live under `{run_dir}/02-plan/` and implementation evidence under `{run_dir}/04-implementation/`.
