...
This skill is normally handed off from [`deep-recon`](../../planning/deep-recon/SKILL.md),
[`spec`](../../planning/spec/SKILL.md), or [`architect`](../../agents/architect/SKILL.md) after documentation and types
leave an implementation question unresolved. Return the fetched source path
and the specific implementation fact it established.
